...
export default function Home() {
  ...
  return (
    ...
    <div className="flex flex-col w-full bg-zinc-950 text-white selection:bg-orange-600 selection:text-white pb-32 overflow-x-hidden">
      ...
      <section className="relative w-full min-h-screen flex flex-col items-center justify-center pt-20 overflow-hidden px-4 sm:px-6">
        ...
        <div className="max-w-7xl w-full mx-auto flex flex-col items-center text-center relative z-20">
          ...
          <div className="inline-flex items-center gap-3 px-6 py-2.5 mb-10 rounded-full border border-[rgba(255,102,0,0.3)] bg-[rgba(10,10,10,0.8)] text-orange-400 w-max text-sm sm:text-base font-semibold">
            ...
            <Zap size={16} /> <span>Дежурная бригада 24/7</span>
          </div>
          ...
          <motion.h1 
            ...
            className="text-[clamp(2.5rem,8vw,8rem)] font-black leading-tight tracking-tight text-white whitespace-nowrap mb-6 will-change-transform"
          >
            ОЧИСТКА ВЕНТИЛЯЦИИ
          </motion.h1>
          ...
          <motion.h2
            ...
            className="text-xl sm:text-3xl lg:text-4xl font-black tracking-[0.15em] uppercase text-transparent bg-clip-text bg-gradient-to-r from-orange-400 via-orange-500 to-orange-600 mb-10 font-mono"
          >
            ПО ГОСТУ ОТ ЖИРА И ПЫЛИ
          </motion.h2>
        ...
        <section className="w-full py-10 sm:py-12 bg-[rgba(10,10,10,0.85)] border-y border-[rgba(255,102,0,0.2)] flex justify-center relative z-20 overflow-hidden">
          ...
          <div className="max-w-7xl w-full px-6 flex flex-wrap justify-center md:justify-between items-center gap-10 sm:gap-12 text-zinc-400 font-medium text-base sm:text-lg relative z-10">
            <div className="flex items-center gap-4 hover:text-white transition-colors group cursor-default">
              <div className="w-[80px] h-[80px] bg-white rounded-2xl flex items-center justify-center p-2 group-hover:scale-110 transition-transform shadow-[0_0_30px_rgba(255,255,255,0.15)] flex-shrink-0">
        ...
        <section className="w-full py-20 bg-zinc-950 px-4 sm:px-6 relative flex justify-center border-t border-zinc-900/40">
          <div className="max-w-7xl w-full">
             <div className="text-center mb-16 px-4">
                <h2 className="text-3xl sm:text-4xl font-bold tracking-tight text-white mb-4 text-balance">Наше <span className="text-orange-500 drop-shadow-[0_0_15px_rgba(234,88,12,0.4)]">Оборудование</span></h2>
                <p className="text-zinc-400 text-base sm:text-lg max-w-2xl mx-auto">Мы не чистим вручную. Профессиональная техника — залог 100% результата по ГОСТ.</p>
             </div>
             
             <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-5xl mx-auto px-4">
                <div className="glass-card p-8 sm:p-10 group">
                   <div className="w-16 h-16 bg-orange-500/10 text-orange-500 rounded-2xl flex items-center justify-center mb-6 border border-[rgba(255,102,0,0.3)] group-hover:scale-110 transition-transform">
                     <Settings size={32} />
                   </div>
                   <h3 className="text-2xl font-bold text-white mb-3">Щеточные машины</h3>
                   <p className="text-zinc-400 leading-relaxed">Индустриальные пневмоустановки вращают жесткие щетки со скоростью до 800 об/мин, проникая в самые труднодоступные изгибы.</p>
                </div>
                ...
                <div className="glass-card p-8 sm:p-10 group">
                   ...
                   <h3 className="text-2xl font-bold text-white mb-3">Вакуумные установки</h3>
                   <p className="text-zinc-400 leading-relaxed">Активная горячая пена расщепляет жир. Мощные вакуумные агрегаты с HEPA-фильтрами моментально всасывают остатки.</p>
                </div>
             </div>
          </div>
        </section>
      ...
      {/* ДО И ПОСЛЕ */}
      <FadeInSection>
        <section className="w-full py-20 sm:py-32 bg-zinc-950 px-4 sm:px-6 flex justify-center border-t border-zinc-900/40">
             ...
             <div className="flex flex-col md:flex-row gap-6 items-center justify-center w-full max-w-5xl mx-auto">
                <div className="flex-1 w-full max-w-sm glass-card group relative">
                  ...
                  <div className="relative w-full aspect-square bg-zinc-900">
                      <Image src="/dirty_hood.png" alt="Грязная вытяжка" fill className="object-cover group-hover:scale-105 transition-transform duration-700 brightness-75" />
                  </div>
                </div>
                ...
                <div className="flex-1 w-full max-w-sm glass-card border-[rgba(255,102,0,0.4)] group relative shadow-[0_0_40px_rgba(234,88,12,0.1)]">
                  ...
                  <div className="relative w-full aspect-square bg-zinc-900">
                      <Image src="/clean_hood.png" alt="Чистая вытяжка" fill className="object-cover group-hover:scale-105 transition-transform duration-700" />
                  </div>
                </div>
             </div>
          </div>
      ...
      <FadeInSection>
        <section className="w-full py-20 bg-zinc-950 px-4 sm:px-6 relative flex justify-center border-t border-zinc-900/40">
          <div className="max-w-7xl w-full mx-auto">
             <div className="text-center mb-16 sm:mb-20 space-y-4">
                <h2 className="text-3xl sm:text-4xl md:text-5xl font-bold tracking-tight text-white mb-6 text-balance">Отзывы <span className="text-orange-500 drop-shadow-[0_0_15px_rgba(234,88,12,0.4)]">наших клиентов</span></h2>
             </div>
             
             <div className="grid grid-cols-1 md:grid-cols-3 gap-6 sm:gap-8 px-4">
                <div className="glass-card p-8 sm:p-10 group">
                   <div className="flex gap-1 text-orange-500 mb-6 group-hover:drop-shadow-[0_0_10px_rgba(234,88,12,0.8)] transition-all">
                   ...
                   <p className="text-zinc-300 leading-relaxed text-base italic mb-8">"Очистили вытяжку от 5-сантиметрового слоя жира за одну ночь. Акт для МЧС выдали сразу."</p>
                   <div className="font-bold text-white text-lg">Игорь</div>
                   <div className="text-sm text-orange-500 font-medium">Владелец сети стейк-хаусов</div>
                </div>
                ...
                <div className="glass-card p-8 sm:p-10 group">
                   ...
                   <p className="text-zinc-300 leading-relaxed text-base italic mb-8">"Работают чисто, после себя не оставляют грязи. Вентиляция теперь работает как новая."</p>
                   <div className="font-bold text-white text-lg">Анна</div>
                   <div className="text-sm text-orange-500 font-medium">Управляющая БЦ</div>
                </div>
                ...
                <div className="glass-card p-8 sm:p-10 group">
                   ...
                   <p className="text-zinc-300 leading-relaxed text-base italic mb-8">"Профессиональное оборудование, быстро справились с цехом 1000 кв.м."</p>
                   <div className="font-bold text-white text-lg">ООО ТехноПром</div>
                   <div className="text-sm text-orange-500 font-medium">Производство</div>
                </div>
             </div>
          </div>
        </section>
