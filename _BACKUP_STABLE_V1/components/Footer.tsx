  ...
  return (
    <footer className="w-full bg-[rgba(10,10,10,0.9)] border-t border-[rgba(255,102,0,0.15)] pt-16 pb-8 px-4 sm:px-6 relative z-20">
      <div className="max-w-7xl mx-auto px-6 grid grid-cols-1 md:grid-cols-4 gap-8">
        <div>
          <div className="text-xl font-bold tracking-tighter text-white mb-4">
            ВентГарант<span className="text-orange-600 font-extrabold">+</span>
          </div>
        ...
        <div>
          ...
          <ul className="space-y-2 text-sm">
            <li><a href="tel:+71234567890" className="hover:text-white transition-colors">+7 (123) 456-78-90</a></li>
            <li><a href="mailto:info@ventgarant.ru" className="hover:text-white transition-colors">info@ventgarant.ru</a></li>
      ...
      <div className="max-w-7xl mx-auto px-6 mt-12 pt-8 border-t border-zinc-800/50 text-xs flex justify-between">
        <p>&copy; {new Date().getFullYear()} ВентГарант+. Все права защищены.</p>
